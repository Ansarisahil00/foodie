...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <a class="navbar-brand" href="index.php"><span style="color:green;font-family: 'Permanent Marker', cursive;">MEDIOUS</span></a>
    <?php
	if(!empty($cust_id))
	{
	?>
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/medications-1853400_1920.jpg" alt="Los Angeles" class="d-block w-100">
      <div class="carousel-caption">
        <h3>Bengaluru</h3>
        <p>We had such a great time in KA</p>
      </div>   
    </div>
    <div class="carousel-item">
      <img src="img/syringe-1884784_1920.jpg" alt="Chicago" class="d-block w-100">
      <div class="carousel-caption">
        <h3>Mumbai</h3>
        <p>We had such a great time in MH</p>
      </div>   
    </div>
    <div class="carousel-item">
      <img src="img/thermometer-1539191_1920.jpg" alt="New York" class="d-block w-100">
      <div class="carousel-caption">
        <h3>Chhenai</h3>
        <p>We had such a great time in TN</p>
      </div>   
    </div>
  </div>
